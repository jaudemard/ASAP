...
class Sphere:
    def __init__(self, center=np.array([0, 0, 0]), radius=1, method="golden", n=92):
        """
    ...
    def _golden_spirale(self, n=92):
        """
        Generate sphere forming points around the atom center using
